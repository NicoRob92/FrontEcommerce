      ...
      <div className={styles.grid}>
        ...
        <div className={styles.boxTwo}>
          ...
          {filter ? (
            ...
            Users.map((e) => <div className={styles.item}>{e.id}</div>)
          ) : (
        ...
        <div className={styles.boxThree}>
          ...
          {filter ? (
            filter?.map((e) => <div className={styles.item}>{e.username}</div>)
          ) : Users ? (
            Users.map((e) => <div className={styles.item}>{e.username}</div>)
          ) : (
            <div>Users Not Found</div>
          )}
        </div>
        <div className={styles.boxFour}>
          ...
          {filter ? (
            filter?.map((e) => <div className={styles.item}>{e.email}</div>)
          ) : Users ? (
            Users.map((e) => <div className={styles.item}>{e.email}</div>)
          ) : (
            <div>Users Not Found</div>
          )}
        </div>
        <div className={styles.boxFive}>
          ...
          {filter ? (
            filter?.map((e) => <div className={styles.item}>{e.role}</div>)
          ) : Users ? (
            Users.map((e) => <div className={styles.item}>{e.role}</div>)
          ) : (
            <div>Users Not Found</div>
          )}
        </div>
